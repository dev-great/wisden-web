...
import Logo from "../assets/images/new/logoW.png"
      ...
      <nav className="navbar navbar-expand-xl">
        <div className="container">
          ...
          <Link className="navbar-brand" to="/">
            <img className="light-mode-item navbar-brand-item" src={Dlogo} alt="logo" />
          ...
          <div className={`navbar-collapse collapse ${isOpen ? "show" : ""}`} id="navbarCollapse">
            <ul className="navbar-nav navbar-nav-scroll mx-auto">
              ...
              <li className="nav-item ">
                <Link className="nav-link" to="/" id="listingMenu">
                  Home
                </Link>
              </li>
              ...
              {/* Nav item Pages */}
              <li className="nav-item ">
                <Link className="nav-link" to="/about-us" id="listingMenu">
                  About Us
                </Link>
              </li>
              ...
              {/* Nav item Pages */}
              <li className="nav-item ">
                <Link className="nav-link" to="/contact" id="listingMenu">
                  Contact Us
                </Link>
              </li>
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu" aria-labelledby="pagesMenu">
                  <li><Link className="dropdown-item" to="#">iOS Download</Link></li>
                  <li><Link className="dropdown-item" to="#">Andriod Download</Link></li>
                </ul>
              </li>
            </ul>
          </div>
          ...
          <ul className="nav flex-row align-items-center list-unstyled ms-xl-auto">
            ...
            <li className="nav-item dropdown">
              {/* Avatar */}
                            ...
                            <a className="nav-notification btn btn-light mb-0 p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
              ...
              <ul className="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
                ...
                <li>
                  <div className="nav-pills-primary-soft theme-icon-active d-flex justify-content-between align-items-center p-2 pb-0">
                    <span>Mode:</span>
                    <button type="button" onClick={() => setTheme('light')} className="btn btn-link nav-link text-primary-hover mb-0 p-0" data-bs-theme-value="light" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Light">
                    ...
                    <button type="button" onClick={() => setTheme('dark')} className="btn btn-link nav-link text-primary-hover mb-0 p-0" data-bs-theme-value="dark" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Dark">
                    ...
                    <button type="button" onClick={() => setTheme('auto')} className="btn btn-link nav-link text-primary-hover mb-0 p-0 active" data-bs-theme-value="auto" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Auto">
